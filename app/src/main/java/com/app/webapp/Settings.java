...
public class Settings {
    public static final String HOST = "sample-videos.com";//endparsehost
//    public static final String HOME_URL = "https://sample-videos.com/download-sample-jpg-image.php";//endparsehomeurl
    public static final String HOME_URL = "https://filesamples.com/formats/jpeg";//endparsehomeurl
    ...
    public static final String PLAY_STORE_LINK_ID = "com.app.webapp"; // package name
    ...
    public static final String [] IN_APP_BILLING_PRODUCT_IDS = new String[] {"product1","product2"};
    //----------------------------- Inapp billing Setup Start --------------------------------------------------
