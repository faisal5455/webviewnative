...
import com.app.webapp.util.AdUtil;
import com.app.webapp.util.BottomMenuUtil;
import com.app.webapp.util.DrawerUtil;
import com.app.webapp.util.FilePicker;
import com.app.webapp.util.GifUtil;
import com.app.webapp.util.InAppBilling;
import com.app.webapp.util.InjectUtil;
import com.app.webapp.util.IntentUtil;
import com.app.webapp.util.LinkUtil;
import com.app.webapp.util.LogUtil;
import com.app.webapp.util.MyJavaScriptInterface;
import com.app.webapp.util.NetworkUtil;
import com.app.webapp.util.PermissionUtil;
import com.app.webapp.util.PrefsUtil;
import com.app.webapp.util.RateDialogUtil;
import com.app.webapp.util.SplashUtil;
import com.app.webapp.util.TimerUtil;
import com.app.webapp.util.Utils;
...
public class Home extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            registerReceiver(CloseHome, new IntentFilter("close"), RECEIVER_EXPORTED);
        }
        else{
...
//                Log.e("tag", "get download permission");
//                ActivityCompat.requestPermissions(Home.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, Home.DOWNLOAD_PERMISSION);
//            }
//            else {
//                downloadFile();
//            }
...
//            }
    ...
    private void downloadFile() {
        ...
        // For devices running Android 10 and above, use the following:
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            request.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, fileName);
        } else {
            // For devices running below Android 10, use the external public directory
            request.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, fileName);
        }
